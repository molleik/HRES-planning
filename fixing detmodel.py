...
class DeterministicModel:
    ...
    def det_solve(self):
        ...
        self.RemStP = self.m.addVars([(s, y, a)
                                      for s in range(self.strg)
                                      for y in range(self.ys, self.years+1)
                                      for a in range(self.years)
                                      ],
                                     vtype=gp.GRB.CONTINUOUS, lb=0,
    ...
    def det_store_decisions(self, yl=20):
        '''
        ...
        -------
        output : dict
            Dict containing all relevant results and information on the model.
