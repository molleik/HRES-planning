...
class StochasticModel:
    ...
    def stoch_store_decisions(self, output, yl=20):
        ...
        for c in range(self.num_scenarios):
            for g in range(self.gen):
                for y in range(self.ys, yl):
                    for d in range(self.days):
                        for h in range(self.hours):
                            DispElec_data[c, g, y - self.ys, d,
                                          h] = self.DispElec[c, g, y, d, h].X
        ...
        for c in range(self.num_scenarios):
            for s in range(self.strg):
                for y in range(self.ys, yl):
                    for d in range(self.days):
                        for h in range(self.hours):
                            Charging_data[c, s, y - self.ys, d,
                                          h] = self.Charging[c, s, y, d, h].X
        ...
        # Discharging
        Discharging_data = np.zeros((self.num_scenarios, self.strg,
                                     yl - self.ys, self.days, self.hours))
        ...
        for c in range(self.num_scenarios):
            for s in range(self.strg):
                for y in range(self.ys, yl):
                    for d in range(self.days):
                        for h in range(self.hours):
                            Discharging_data[c, s, y - self.ys, d, h] = \
                                self.Discharging[c, s, y, d, h].X
        ...
        for c in range(self.num_scenarios):
            for s in range(self.strg):
                for y in range(self.ys, yl):
                    for d in range(self.days):
                        for h in range(self.hours):
                            SoC_data[c, s, y - self.ys,
                                     d, h] = self.SoC[c, s, y, d, h].X
        ...
        for c in range(self.num_scenarios):
            for g in range(self.gen):
                for y in range(self.ys, yl):
                    for d in range(self.days):
                        for h in range(self.hours):
                            SoldGen_data[c, g, y - self.ys,
                                         d, h] = self.SoldGen[c, g, y, d, h].X
        ...
        SoldStorage_data = np.zeros((self.num_scenarios, self.strg,
                                     yl - self.ys, self.days, self.hours))
        ...
        for c in range(self.num_scenarios):
            for s in range(self.strg):
                for y in range(self.ys, yl):
                    for d in range(self.days):
                        for h in range(self.hours):
                            SoldStorage_data[c, s, y - self.ys, d, h] = \
                                self.SoldStorage[c, s, y, d, h].X
        ...
        for c in range(self.num_scenarios):
            for y in range(self.ys, yl):
                USDemYC[c, y - self.ys] = gp.quicksum(
                    self.USDem[c, y, d, h]
                    for d in range(self.days)
                    for h in range(self.hours)
                ).getValue()
        ...
        for c in range(self.num_scenarios):
            for y in range(self.ys, yl):
                chargingYC[c, y - self.ys] = gp.quicksum(
                    self.Charging[c, s, y, d, h]
                    for s in range(self.strg)
                    for d in range(self.days)
                    for h in range(self.hours)
                ).getValue()
        ...
        for c in range(self.num_scenarios):
            for y in range(self.ys, yl):
                soldGenYC[c, y - self.ys] = gp.quicksum(
                    self.SoldGen[c, g, y, d, h]
                    for g in range(self.gen)
                    for d in range(self.days)
                    for h in range(self.hours)
                ).getValue()
        ...
        for c in range(self.num_scenarios):
            for y in range(self.ys, yl):
                soldStorageYC[c, y - self.ys] = gp.quicksum(
                    self.SoldStorage[c, s, y, d, h]
                    for s in range(self.strg)
                    for d in range(self.days)
                    for h in range(self.hours)
                ).getValue()
        ...
        for c in range(self.num_scenarios):
            for y in range(self.ys, yl):
                dispElecDieselYC[c, y - self.ys] = gp.quicksum(
                    self.DispElec[c, g,  y, d, h]
                    for g in self.diesel_index
                    for d in range(self.days)
                    for h in range(self.hours)
        ...
        for c in range(self.num_scenarios):
            for y in range(self.ys, yl):
                dispElecPVYC[c, y - self.ys] = gp.quicksum(
                    self.DispElec[c, g, y, d, h]
                    for g in self.pv_index
                    for d in range(self.days)
                    for h in range(self.hours)
        ...
        for c in range(self.num_scenarios):
            for y in range(self.ys, yl):
                dispElecWindYC[c, y - self.ys] = gp.quicksum(
                    self.DispElec[c, g,  y, d, h]
                    for g in self.wind_index
                    for d in range(self.days)
                    for h in range(self.hours)
        ...
        for c in range(self.num_scenarios):
            for y in range(self.ys, yl):
                dischargingYC[c, y - self.ys] = gp.quicksum(
                    self.Discharging[c, s, y, d, h]
                    for s in range(self.strg)
                    for d in range(self.days)
                    for h in range(self.hours)
        ...
        for c in range(self.num_scenarios):
            for y in range(self.ys, yl):
                ExDemYC[c, y - self.ys] = gp.quicksum(
                    self.ExElec[c, y, d, h]
                    for d in range(self.days)
                    for h in range(self.hours)
                ).getValue()
        ...
        for c in range(self.num_scenarios):
            for y in range(self.ys, yl):
                PurElecYC[c, y - self.ys] = gp.quicksum(
                    self.PurElec[c, y, d, h]
                    for d in range(self.days)
                    for h in range(self.hours)
                ).getValue()
        ...
        yearlyIndex = pd.MultiIndex.from_product(
            [range(self.num_scenarios), yearlyNames],
