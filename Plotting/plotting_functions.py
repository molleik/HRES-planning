...
def plot_NPV(output, out_dir=None, alpha=1, model_type='',
    ...
    revenues = ['Salvage Value', 'Retirement Revenues', 'Electricity Revenues']
...
def model_comparison(main_dir, out_dir):
    ...
    stochastic and Receding Horizon models.
